...
<template>
  <div class="error-page">
    <div class="error-card">
      <Icon name="Lock" :size="48" class="emoji" />
      <h1 class="code">403</h1>
      <h2 class="title">无访问权限</h2>
      <p class="desc">你没有权限访问此页面<br />如有疑问请联系管理员</p>
      <div class="actions">
...
.error-page {
  /* 高度取 --app-height（见 reset.scss）：standalone 下 WebKit 会少算动态
     视口高度，写死 100% / 100dvh 会让页面底部空出一条。 */
