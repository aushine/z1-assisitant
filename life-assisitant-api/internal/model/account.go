...
type Account struct {
	...
	Icon        string         `gorm:"column:icon;type:varchar(32);not null;default:💰"  json:"icon"`
	Institution string         `gorm:"column:institution;type:varchar(20);not null;default:''" json:"institution"`
