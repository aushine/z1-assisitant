...
-- ----------------------------
-- Table structure for period_days
-- ----------------------------
DROP TABLE IF EXISTS `period_days`;
CREATE TABLE `period_days`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'pd_xxxx 格式（utility.NewID("pd")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  `bbt` decimal(4, 2) NULL DEFAULT NULL COMMENT '基础体温 ℃，34.00~42.00',
  ...
  CONSTRAINT `fk_period_day_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '经期逐日记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for period_cycles
-- ----------------------------
DROP TABLE IF EXISTS `period_cycles`;
CREATE TABLE `period_cycles`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'pc_xxxx 格式（utility.NewID("pc")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  `note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '周期备注',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  ...
  CONSTRAINT `fk_period_cycle_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '经期周期（由 period_days 派生）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for period_settings
-- 注意：没有 hide_tab 列 —— 隐私遮罩（👁）是前端 localStorage 的设备级状态
-- ----------------------------
DROP TABLE IF EXISTS `period_settings`;
CREATE TABLE `period_settings`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'ps_xxxx 格式（utility.NewID("ps")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  CONSTRAINT `fk_period_setting_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '经期设置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `health_days`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'hd_xxxx（utility.NewID("hd")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  CONSTRAINT `fk_health_day_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '身体指标逐日记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of health_events（2026-09-19 新增：身体指标时间轴，多次记录、不延续）
-- ----------------------------
DROP TABLE IF EXISTS `health_events`;
CREATE TABLE `health_events`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'he_xxxx（utility.NewID("he")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  `date` date NOT NULL COMMENT '归属日期（冗余，按天查能走索引）',
  `time_of_day` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '一天内的时刻 HH:mm，如 09:20',
  `metric_key` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'water / bbt / weight / sleep / bowel',
  ...
  `note` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '这一次记录的备注（不延续）',
  `created_at` datetime NULL DEFAULT NULL,
  `updated_at` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  ...
  CONSTRAINT `fk_health_event_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '健康时间轴事件（身体指标多次记录）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of health_settings
-- ----------------------------
DROP TABLE IF EXISTS `health_settings`;
CREATE TABLE `health_settings`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'hs_xxxx（utility.NewID("hs")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  CONSTRAINT `fk_health_setting_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '健康模块用户配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `anniversaries`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'an_xxxx（utility.NewID("an")）',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所属用户（users.id）',
  ...
  `category` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'other' COMMENT 'birthday/anniversary/countdown/other',
  `icon` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'calendar-heart' COMMENT '图标名',
  `color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'primary' COMMENT '语义色名',
  ...
  CONSTRAINT `fk_anniversary_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '纪念日/倒数日' ROW_FORMAT = Dynamic;
