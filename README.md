...
├── md/spec/                              ← 设计文档总集（活文档，随代码回写）
│                                         ← 历史设计稿在本地 md/archive/，不入库
│
...
完整设计文档在 **[`md/spec/`](./md/spec/)** —— **总集活文档（17 篇）**，描述的是「**现在代码里是什么样**」，
不是某一次的设计稿。改了代码必须回写对应章节，入口见 [`md/spec/README.md`](./md/spec/README.md)。

> 2026-08 ~ 09 的 14 批历史设计稿躺在本地 `md/archive/`，**未纳入版本库**（`.gitignore` 的 `md/archive/`），
> 与总集冲突时一律以总集为准。
...
| 你是    | 先看这些                                                                                                                |
|:----- |:------------------------------------------------------------------------------------------------------------------- |
| 产品经理  | [`00-总览`](./md/spec/00-总览.md) · [`01-信息架构与导航`](./md/spec/01-信息架构与导航.md) · 各业务模块篇                                    |
| 设计师   | [`02-设计系统`](./md/spec/02-设计系统.md) · 各业务模块篇                                                                          |
| 前端工程师 | [`01-信息架构与导航`](./md/spec/01-信息架构与导航.md) · [`02-设计系统`](./md/spec/02-设计系统.md) · 各业务模块篇                                |
| 后端工程师 | [`03-数据模型`](./md/spec/03-数据模型.md) · [`04-API与错误码`](./md/spec/04-API与错误码.md) · [`14-技术栈与部署`](./md/spec/14-技术栈与部署.md) |
| 测试工程师 | 各业务模块篇的「已知问题」章节 · [`99-附录`](./md/spec/99-附录.md) 的缺陷与断线清单                                                            |
| 运维    | [`14-技术栈与部署`](./md/spec/14-技术栈与部署.md)                                                                               |
...
- 提交前先读对应模块的 spec（[`md/spec/`](./md/spec/)）
- **API 变更**同步更新 [`04-API与错误码`](./md/spec/04-API与错误码.md) 与 [`03-数据模型`](./md/spec/03-数据模型.md)
- **新功能**先写 spec 再开发
- **代码改动落地后回写 spec** —— 总集描述的是「现在代码里是什么样」，别让实现与文档漂移
